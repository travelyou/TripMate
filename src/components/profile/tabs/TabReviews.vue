  ...
  <div class="space-y-4">
    ...
    <div class="flex space-x-4 border-b border-secondary-100 pb-2 mb-4">
      <button
        ...
        :class="activeTab === 'received' ? 'text-primary-600' : 'text-secondary-400 hover:text-secondary-600'"
      ...
      <button
        class="text-sm font-bold pb-2 transition-colors relative"
        :class="activeTab === 'given' ? 'text-primary-600' : 'text-secondary-400 hover:text-secondary-600'"
    ...
    <div v-else class="text-center py-20 text-secondary-400 flex flex-col items-center">
      <div class="w-16 h-16 bg-secondary-100 rounded-full flex items-center justify-center mb-4 text-2xl grayscale opacity-50">
